...
Transformasi digital telah mengubah lanskap persaingan bisnis secara radikal, khususnya pada industri kuliner cepat saji melalui penerapan *e-business* yang mengintegrasikan layanan operasional dengan pengelolaan reputasi digital (*digital reputation management*) [1][2]. Platform *crowdsourced* seperti Google Maps Reviews kini menjadi salah satu kanal utama di mana konsumen membagikan pengalaman mereka secara terbuka melalui rating bintang (1–5) serta ulasan tekstual [3]. Ulasan digital ini memainkan peran krusial bagi keberlangsungan bisnis karena sentimen positif dan rating rata-rata yang tinggi berbanding lurus dengan peningkatan visibilitas digital, daya tarik konsumen baru, serta retensi pelanggan lama [4]. Sebaliknya, akumulasi ulasan negatif yang tidak ditangani secara proaktif berpotensi merusak citra merek (*brand image*) dan menurunkan volume penjualan secara drastis [5]. Fenomena ini terlihat jelas pada jaringan restoran Mie Gacoan yang mengalami ekspansi masif di Indonesia, di mana tingginya popularitas menghasilkan ratusan hingga ribuan ulasan per cabang setiap bulannya sehingga analisis manual tidak lagi efisien untuk dilakukan [6].

Meskipun melimpah, data ulasan digital Mie Gacoan menghadapi sejumlah tantangan operasional dan teknis yang kompleks. Tingginya volume ulasan tekstual tidak terstruktur dengan ragam tata bahasa tidak baku menyulitkan ekstraksi keluhan utama secara cepat dan akurat. Selain itu, terdapat inkonsistensi kualitas pelayanan dan produk antar cabang yang belum terpetakan secara sistematis, serta adanya fluktuasi rating berbasis waktu (hari/bulan) yang memerlukan analisis akar masalah (*root cause analysis*) untuk memahami pola kemerosotannya. Permasalahan ini diperparah oleh lambatnya respon terhadap keluhan kritis (ulasan bintang 1) akibat belum tersedianya sistem peringatan dini *real-time*, sehingga menghambat upaya pemulihan layanan (*service recovery*) sebelum berdampak negatif pada reputasi merek secara keseluruhan.

Untuk mengatasi permasalahan tersebut, penelitian ini bertujuan mengimplementasikan kerangka kerja *data science* dan arsitektur *big data* terintegrasi guna mengotomatisasi pemrosesan ulasan dan mendukung pengambilan keputusan operasional yang presisi. Penelitian ini diawali dengan pembangunan *pipeline* manajemen data (*ETL* dan *feature engineering*) dari 22.550 ulasan pada 20 cabang Mie Gacoan, dilanjutkan dengan analisis korelasi karakteristik teks serta pemodelan regresi untuk mengidentifikasi tren jangka panjang dan pola musiman (*seasonality*). Selanjutnya, pendekatan *machine learning* diterapkan melalui model klasifikasi *Random Forest* untuk prediksi kepuasan ulasan dan algoritma *K-Means* untuk segmentasi performa cabang. Penelitian ini juga mengestimasi dampak kausal (*Average Treatment Effect*) dari atribut pelayanan terhadap rating, serta mensimulasikan arsitektur *big data streaming* berbasis *producer-consumer* guna mendeteksi ulasan buruk secara *real-time* sebagai solusi peringatan dini bagi manajemen operasional.
...
Menggunakan estimasi dampak kausal untuk mengukur efek intervensi tertentu terhadap rating.
